        ...
        <>
            ...
            <header className="container-m">
                <div className="d-flex flex-sm-row">
                    <Link to='/'>
                        <img id="logo" src={"https://i.ibb.co/QYHKKYS/Hexa-white-01.png"} alt={"Hexagon"} ></img>
                    </Link>
                </div>
                ...
                <div id="iconsContainer">
                    <IconButton id="notifications" aria-label="cart">
                        <Link id="messagesLink" to='/messages'>
                            <StyledBadge color="secondary">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-envelope headerSVG" viewBox="0 0 16 16">
                    ...
                    <IconButton id="notifications" aria-label="cart" type="submit" onClick={showNotifications}>
                        <StyledBadge badgeContent={results ? showNotificationsList.length : notificationsCount}
                            color="secondary">
                            <svg  xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-bell headerSVG" viewBox="0 0 16 16">
