...
const Header = () => {
    ...
    function showNotifications(e) {
        ...
        if (notificationsList.type === "password") {
            notificationsList.type = "text";
            setNotifications(true);
        }
        else {
            notificationsList.type = "password";
        ...
        <>
            <header class="container-m">
                ...
                <div id="iconsContainer">
                    ...
                    <Button id="userHeaderContainer">
                    <img id="userHeaderImage" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTHZMTLWh4KIE7ogS6hfTgeKuTVTPxlM1qe6Q&amp;usqp=CAU" class="MuiAvatar-img" alt="User-Header"></img>
                    </Button>
